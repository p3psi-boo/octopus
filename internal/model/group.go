...
type Group struct {
	...
	CircuitBreakerEnabled bool        `json:"circuit_breaker_enabled" gorm:"default:true"` // 是否启用熔断器
...
type GroupUpdateRequest struct {
	...
	CircuitBreakerEnabled *bool                    `json:"circuit_breaker_enabled,omitempty"` // 仅在熔断器开关变更时发送
